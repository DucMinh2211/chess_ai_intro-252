# Bảng theo dõi tiến độ báo cáo (Chess AI)

## 1. Nội dung các chương (Contents)
- [x] **Chương 0: Tóm tắt (Summary/Abstract)**
- [x] **Chương 1: Giới thiệu vấn đề (Introduction)**
    - [x] 1.1.1 Đặt vấn đề
    - [x] 1.1.2 Các phương pháp tiếp cận
    - [x] 1.2 Mục tiêu đề tài
...
- [x] **Trang bìa (Title Page):** Đã có nhưng cần kiểm tra lại thông tin nhóm.
